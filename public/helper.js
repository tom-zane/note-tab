(function () {
    ...
    r("Symbol", function (a) {
        function b(e) { if (this instanceof b) throw new TypeError("Symbol is not a constructor"); return new c(d + (e || "") + "_" + f++, e) }
    ...
    function la(a, b) {
        z(a.g); var c = a.g.h; if (c) return D(a, "return" in c ? c["return"] : function (d) { return { value: d, done: !0 } }, b, a.g.return);
    ...
    function ma(a) {
        this.next = function (b) { z(a.g); a.g.h ? b = D(a, a.g.h.next, b, a.g.s) : (a.g.s(b), b = E(a)); return b };
    ...
    function na(a) {
        ...
        return new Promise(function (d, f) {
            function e(h) { h.done ? d(h.value) : Promise.resolve(h.value).then(b, c).then(e, f) }
            e(a.next())
        })
    }
    function oa(a) { return na(new ma(new ka(a))) }
    r("Promise", function (a) {
        function b(h) { this.h = 0; this.i = void 0; this.g = []; this.s = !1; var g = this.j(); try { h(g.resolve, g.reject) } catch (k) { g.reject(k) } }
        ...
        b.prototype.j = function () {
            function h(l) { return function (m) { k || (k = !0, l.call(g, m)) } }
        ...
        b.prototype.then = function (h, g) {
            function k(w, A) { return typeof w == "function" ? function (ba) { try { l(w(ba)) } catch (ca) { m(ca) } } : A }
        ...
        b.prototype.B = function (h, g) {
            function k() { switch (l.h) { case 1: h(l.i); break; case 2: g(l.i); break; default: throw Error("Unexpected state: " + l.h); } }
        ...
        b.all = function (h) {
            var g = x(h), k = g.next(); return k.done ? d([]) : new b(function (l, m) {
                function u(ba) { return function (ca) { w[ba] = ca; A--; A == 0 && l(w) } }
    ...
    r("WeakMap", function (a) {
        function b(k) { this.g = (g += Math.random() + 1).toString(); if (k) { k = x(k); for (var l; !(l = k.next()).done;)l = l.value, this.set(l[0], l[1]) } }
        function c() { }
    ...
    r("Map", function (a) {
        function b() { var g = {}; return g.previous = g.next = g.head = g }
    ...
    r("Set", function (a) {
        function b(c) { this.g = new Map; if (c) { c = x(c); for (var d; !(d = c.next()).done;)this.add(d.value) } this.size = this.g.size }
    ...
    r("Array.from", function (a) {
        return a ? a : function (b, c, d) {
            c = c != null ? c : function (g) { return g };
    ...
    ; var ua = Array.prototype.indexOf ? function (a, b) { return Array.prototype.indexOf.call(a, b, void 0) } : function (a, b) {
        if (typeof a === "string") return typeof b !== "string" || b.length != 1 ? -1 : a.indexOf(b, 0);
        for (var c = 0; c < a.length; c++)if (c in a && a[c] === b) return c; return -1
    }, va = Array.prototype.forEach ? function (a, b, c) { Array.prototype.forEach.call(a, b, c) } : function (a, b, c) { for (var d = a.length, f = typeof a === "string" ? a.split("") : a, e = 0; e < d; e++)e in f && b.call(c, f[e], e, a) };
    ...
    function eb(a) {
        var b = {}; a.forEach(function (c) { b[c[0]] = c[1] });
    ...
    function gb() {
        if (db()) {
            var a = S.brands.find(function (b) { return b.brand === "Chromium" });
            if (!a || !a.version) return NaN; a = a.version.split(".")
        } else { a = fb(); if (a === "") return NaN; a = a.split(".") } return a.length === 0 ? NaN : Number(a[0])
    }
    ...
    function rb() {
        var a = new pb, b = ["https://www.youtube.com"]; b = b === void 0 ? ob : b; oa(function (c) {
            switch (c.g) {
                case 1: return C(c, qb(), 2); case 2: if (!c.m) { c.g = 3; break } return C(c, Promise.all(b.map(function (d) { var f; return oa(function (e) { if (e.g == 1) return e.l = 2, C(e, navigator.permissions.query({ name: "top-level-storage-access", requestedOrigin: d }), 4); e.g != 2 ? (f = e.m, f.state === "prompt" && a.g.push(d), e.g = 0, e.l = 0) : (e.l = 0, e.i = null, e.g = 0) }) })), 4);
    ...
    ; var W = window;
    function X(a, b) {
        this.v = {}; this.playerInfo = {}; this.videoTitle = ""; this.i = this.g = null; this.h = 0; this.m = !1; this.l = []; this.j = null; this.A = {}; this.options = null; if (!a) throw Error("YouTube player element ID required."); this.id = qa(this); b = Object.assign({ title: "video player", videoId: "", width: 640, height: 360 }, b || {}); var c = document; if (a = typeof a === "string" ? c.getElementById(a) : a) {
            W.yt_embedsEnableRsaforFromIframeApi && rb(); c = a.tagName.toLowerCase() === "iframe"; b.host || (b.host = c ? lb(a.src) : "https://www.youtube.com"); this.options =
                b || {}; b = [this.options, window.YTConfig || {}]; for (var d = 0; d < b.length; d++)b[d].host && (b[d].host = b[d].host.toString().replace("http://", "https://")); c || (W.yt_embedsEnableAutoplayAndVisibilitySignals ? (b = document.createElement("iframe"), zb(this, b, a), this.i = a, hb(b, a), Ab(this, b, Bb(this, b)), a = b) : (b = document.createElement("iframe"), zb(this, b, a), Ab(this, b, Bb(this)), this.i = a, hb(b, a), a = b)); this.g = a; this.g.id || (this.g.id = "widget" + qa(this.g)); V[this.g.id] = this; if (window.postMessage) {
                    this.j = new T; Cb(this); a = Y(this,
    ...
    function Bb(a, b) {
        var c = Y(a, "playerVars"); c ? c = Ka(c) : c = {}; window !== window.top && document.referrer && (c.widget_referrer = document.referrer.substring(0, 256)); var d = Y(a, "embedConfig"); if (d) { if (H(d)) try { d = JSON.stringify(d) } catch (f) { console.error("Invalid embed config JSON", f) } c.embed_config = d } c.enablejsapi = window.postMessage ? 1 : 0; window.location.host && (c.origin = window.location.protocol + "//" + window.location.host); c.widgetid = a.id; window.location.href && va(["debugjs", "debugcss"], function (f) {
    ...
    function Kb(a, b) {
        b = x(b); for (var c = b.next(), d = {}; !c.done; d = { u: void 0 }, c = b.next())d.u = c.value, a[d.u] || (d.u === "getCurrentTime" ? a[d.u] = function () { var f = this.playerInfo.currentTime; if (this.playerInfo.playerState === 1) { var e = (Date.now() / 1E3 - this.playerInfo.currentTimeLastUpdated_) * this.playerInfo.playbackRate; e > 0 && (f += Math.min(e, 1)) } return f } : xb(d.u) ? a[d.u] = function (f) {
            return function () {
                this.playerInfo = {};
                this.v = {}; Fb(this, f.u, arguments); return this
            }
        }(d) : yb(d.u) ? a[d.u] = function (f) {
            return function () {
                var e = f.u, h = 0;
                e.search("get") === 0 ? h = 3 : e.search("is") === 0 && (h = 2); return this.playerInfo[e.charAt(h).toLowerCase() + e.substring(h + 1)]
            }
        }(d) : a[d.u] = function (f) {
            return function () {
    ...
    function Hb(a, b, c) {
        Z || (Z = {}, Lb = new Set, Nb.addEventListener("message", function (d) {
            a: if (Lb.has(d.origin)) {
                try { var f = JSON.parse(d.data) } catch (g) { break a } var e = Z[f.id]; if (e && d.origin === e.N) switch (d = e.U, d.m = !0, d.m && (va(d.l, d.sendMessage, d), d.l.length = 0), e = f.event, f = f.info, e) {
                    case "apiInfoDelivery": if (H(f)) for (var h in f) f.hasOwnProperty(h) && (d.v[h] = f[h]); break; case "infoDelivery": Jb(d, f); break; case "initialDelivery": H(f) && (clearInterval(d.h), d.playerInfo = {}, d.v = {}, Kb(d, f.apiInterface), Jb(d, f)); break; default: d.j.i ||
    ...
    typeof YTConfig !== "undefined" && YTConfig.parsetags && YTConfig.parsetags !== "onload" || ub(); var Ob = G.onYTReady; Ob && Ob(); var Pb = G.onYouTubeIframeAPIReady; Pb && Pb(); var Qb = G.onYouTubePlayerAPIReady; Qb && Qb();
}).call(this);